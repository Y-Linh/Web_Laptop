...
// Cấu hình Express để phục vụ các tệp tĩnh từ thư mục build của React
...
// Nếu không tìm thấy route nào (ví dụ khi người dùng truy cập vào /), gửi index.html của React
app.get('*', (req, res) => {
